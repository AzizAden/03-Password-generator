...
function generatePassword() {
  ...
  while (chooseLength <= 7 || chooseLength >= 129) {
    ...
    chooseLength = prompt("How many characters would you like your password to contain?");
  }
  ...
  while (chooseUpperCase === false && chooseLowerCase === false && chooseSpecialCharacter === false && chooseNumericCharacter === false) {
    ...
    chooseLowerCase = confirm("Click OK to confirm if you would like to include lowercase characters");
    chooseUpperCase = confirm("Click OK to confirm if you would like to include uppercase characters");  
    chooseSpecialCharacter = confirm("Click OK to confirm if you would like to include special characters");
    chooseNumericCharacter = confirm("Click OK to confirm if you would like to include numeric characters");    
  } 
